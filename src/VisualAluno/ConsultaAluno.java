...
public class ConsultaAluno extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        agButton = new javax.swing.JRadioButton();
        apgButton = new javax.swing.JRadioButton();
        ...
        agButton.setText("Aluno Graduação");

        apgButton.setText("Aluno Pós Graduação");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGap(56, 56, 56)
                .addComponent(agButton)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 88, Short.MAX_VALUE)
                .addComponent(apgButton)
                .addGap(34, 34, 34)
    ...
    private void okButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_okButtonActionPerformed
        if(agButton.isSelected()){
            ConsultaAlunoGraduacao ca = new ConsultaAlunoGraduacao();
            ca.setVisible(true);
            dispose();
        } 
        else if( apgButton.isSelected()){
            ConsultaAlunoPos cp = new ConsultaAlunoPos();
            cp.setVisible(true);
            dispose();
        }
        else
    ...
    private javax.swing.JRadioButton agButton;
    private javax.swing.JRadioButton apgButton;
